...
@WebFilter(filterName = "myFilter", urlPatterns = {"/*"}, servletNames = {}, dispatcherTypes = {DispatcherType.REQUEST})
...
//loadListFormServlet
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if(session != null) {
            ...
            if (!pageName.toLowerCase().contains("login") && !pageName.equals("home.jsp")) {
